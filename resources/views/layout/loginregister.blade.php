...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link rel="canonical" href="{{asset ('https://getbootstrap.com/docs/5.3/examples/sign-in/')}}">
    <link rel="stylesheet" href="{{asset ('https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css')}}" integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">
    ...
    <link rel="manifest" href="{{asset ('/docs/5.3/assets/img/favicons/manifest.json')}}">
